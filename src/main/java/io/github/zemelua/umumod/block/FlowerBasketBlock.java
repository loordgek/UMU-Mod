...
public class FlowerBasketBlock extends Block {
	...
	private static final VoxelShape GROUNDED_SHAPE = VoxelShapes.or(Block.makeCuboidShape(5.0D, 0.0D, 5.0D, 11.0D, 7.0D, 11.0D), Block.makeCuboidShape(6.0D, 7.0D, 6.0D, 10.0D, 9.0D, 10.0D));
	...
	public FlowerBasketBlock(AbstractBlock.Properties properties) {
		super(properties);
